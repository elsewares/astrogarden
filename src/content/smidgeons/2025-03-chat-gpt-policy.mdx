...
This all seems extremely fine to me. Perhaps my standards for politicians are too low, but I assume they don't actually know much and rely heavily on advisors to define terms for them and decide on policy improvements. And I think ChatGPT connected to some grounded sources would be a really good policy advisor. Better than most human policy advisors. At least when it comes to consistency, rapidly searching and synthesising lots of documents, and avoiding personal and emotional bias.

It feels strange to sit in a moment where Trump and Musk are implementing policies that trigger trade wars and crash the U.S. economy. And think "What if we just put Claude in charge?"
