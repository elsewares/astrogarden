...
This is a talk I presented [Local-first Conference](https://www.localfirstconf.com/) in Berlin, May <YearsAgo>2024</YearsAgo>. It's specifically directed at the [local-first](https://www.inkandswitch.com/local-first/) community, but its relevant to anyone involved in building software.
