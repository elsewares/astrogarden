...
import Tween from "../../components/mdx/Tween.astro";
...
<Center>
	<ButtonLink href="https://codesandbox.io/s/reacthooks-greensock-demo-xjoti?file=/src/AnimatedBox.js">
		Jump into CodeSandbox
	</ButtonLink>
</Center>
