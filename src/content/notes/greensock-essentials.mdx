...
import GsapScroller from "../../components/mdx/GreensockScroller.astro";
import Center from "../../components/mdx/Center.astro";
import TweenRedBigBox from "../../components/mdx/TweenRedBigBox.astro";
import TweenSpinningBox from "../../components/mdx/TweenSpinningBox.astro";
import TweenReverseSpinningBox from "../../components/mdx/TweenReverseSpinningBox.astro";
import TweenBlueRedBox from "../../components/mdx/TweenBlueRedBox.astro";
