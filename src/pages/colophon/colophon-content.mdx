...
Hyphae <Icon name="hyphae" width="18" height="18" /> are connective tissues—the cross-pollination of two or more spores to create a new soma. This is the primary reason I have for putting everything in this one container: to see what happens when I place Idea A next to Idea Q.
